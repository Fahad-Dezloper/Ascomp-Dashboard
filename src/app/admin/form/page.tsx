...
export default function FormBuilderPage() {
  ...
  const saveConfig = async () => {
    ...
    console.log(
      "Sample field:",
      fieldConfigs.find((f) => f.key === "serviceVisitType"),
    );
    ...
    try {
      ...
      alert(
        `Failed to save form configuration: ${error instanceof Error ? error.message : String(error)}`,
      );
    }
  };
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Customize form fields, types, and dropdown options
            </p>
          </div>
          <Button
            onClick={saveConfig}
                            ...
                            {field.options?.map((option, idx) => {
                              ...
                              return (
                                <div key={idx} className="space-y-1">
                                  <div className="flex items-center gap-2">
                                    <Input
                                      ...
                                      onChange={(e) => {
                                        ...
                                        const currentSubOptionsInput = {
                                          ...(field.subOptionsInput || {}),
                                        };
                                        if (
                                          oldOption &&
                                          oldOption !== newOptionValue
                                        ) {
                                          if (currentSubOptions[oldOption]) {
                                            currentSubOptions[newOptionValue] =
                                        ...
                                        updateField(field.key, {
                                          options: newOptions,
                                          subOptions:
                                            Object.keys(currentSubOptions)
                                              .length > 0
                                              ? currentSubOptions
                                              : undefined,
                                          subOptionsInput:
                                            Object.keys(currentSubOptionsInput)
                                              .length > 0
                                              ? currentSubOptionsInput
                                              : undefined,
                                        });
                                  ...
                                  {isExpanded && (
                                    <div className="ml-6 pl-3 border-l-2 border-gray-300 space-y-2 py-2">
                                      <p className="text-xs text-gray-500">
                                        Sub-options for &ldquo;
                                        {option}&rdquo;
                                      </p>
